...
const economico = [
  ...
  description: 'Suporte'
    ...
    id: 5,
    description: 'Integração com WhatssApp'
    },
];
...
const premium = [
  {
    id: 1,
    description: 'Notas Fiscais (NF-0e/NFC-e)',
  },{
    id: 3,
    description: 'Espaço Ilimitado'
  },{ 
...
const Plans = (props) => {
  return (
    <section className={styles.topp} id="plans">
      <Container>
        <Row className="justify-content-center">
        <TitleGridItem 
         slogan="Planos"
         title="Melhores Planos "
       />
            ...
            <Table className={styles.price_table}>
             <Tbody>
              <Tr>
                <Td className={styles.price_blank}></Td>
                <Td className={styles.price_blank}></Td>
                <Td className={styles.price_table_popular}>Mais aderido</Td>
                <Td className={styles.price_blank}></Td>
              </Tr>
              ...
              <Tr className={styles.price_table_head}>
                ...
                <Td className={styles.green_width}>
                    ULTRA
                    <br/>
                    <small style={{fontSize: 12, fontWeight: 400}}>Em breve...</small>
                </Td>
              </Tr>
              ...
              <Tr>
                    ...
                    <Td className={styles.price}>
                                    ...
                                    <br/>Em breve...
                                    <br/>
                                    <a href="#Contact">Conheça mais</a>
                                </Td>
              </Tr>
              
              <Tr>
                <Td> 
                  <span  style={{fontSize: 15, fontWeight: 600}}> Emissor de NF-e
                    <a href="#wordpress-asset-updates" className={styles.price_table_help}>
            ...
            <Tr>
                <Td> 
                  <span  style={{fontSize: 15, fontWeight: 600}}> Emissor de NFC-e
                    <a href="#wordpress-asset-updates" className={styles.price_table_help}>
                      <i className="far fa-fw fa-question-circle"></i>
                    </a>    
                  </span>      
          ...
          {/*
            <tr>
                <Td>
                  <span>  Sites
                    <a href="#" className={styles.price_table_help}>
                      <i className="far fa-fw fa-question-circle"></i>
                    </a>    
                  </span>   
                </Td>
